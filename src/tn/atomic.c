...
{
    return aws_atomic_load_int_explicit((const volatile struct aws_atomic_var *)a, TN_ATOMIC_ACQUIRE);
}
...
{
    return aws_atomic_load_ptr_explicit((const volatile struct aws_atomic_var *)a, TN_ATOMIC_ACQUIRE);
}
...
{
    aws_atomic_store_int_explicit((volatile struct aws_atomic_var *)a, val, TN_ATOMIC_RELEASE);
}
...
{
    aws_atomic_store_ptr_explicit((volatile struct aws_atomic_var *)a, val, TN_ATOMIC_RELEASE);
}
...
{
    return aws_atomic_fetch_add_explicit((volatile struct aws_atomic_var *)a, val, TN_ATOMIC_ACQ_REL);
}
